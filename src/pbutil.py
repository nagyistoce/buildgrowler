...
#
#    BuildGrowler Copyright (C) 2007 Christian L. Jacobsen
#
#    This file is part of BuildGrowler. It was taken verbatim from the BuildBot
#    distribution (licensed using the GNU General Public License according to
#    sourceforge: https://sourceforge.net/projects/buildbot/). This file had no
#    GPL notice, which has been added.
#
